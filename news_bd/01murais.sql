...
CREATE TABLE `murais` (
  ...
  `start_panel_id` int DEFAULT NULL,
...
ALTER TABLE `murais`
  ...
  ADD KEY `mural_start_panel_id_foreign` (`start_panel_id`);
...
ALTER TABLE `murais`
  ...
  ADD CONSTRAINT `mural_start_panel_id_foreign` FOREIGN KEY (`start_panel_id`) REFERENCES `paineis` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
