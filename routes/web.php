...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/sala/enter/{id}', [App\Http\Controllers\SalaController::class, 'enter'])->name('sala.enter');
    ...
    Route::get('/sala/qrcode/{id}', [App\Http\Controllers\SalaController::class, 'createQrCode'])->name('sala.qrcode');
