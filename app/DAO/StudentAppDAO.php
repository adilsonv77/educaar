...
join turmas t on t.turma_modelo_id = c.turma_modelo_id
join alunos_turmas atu on t.id = atu.turma_id
...
*/
        $sql = DB::table('activities as a')
            ...
            ->join("turmas as t", "t.turma_modelo_id", "=", "c.turma_modelo_id")
            ->join("alunos_turmas as atu", "t.id", "=", "atu.turma_id")
