                ...
                @if($acao != 'edit')
                    ...
                    <div class="modal fade" id="pontuadaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content" >
                                <div class="modal-body">
                                    <h3>Atividades Pontuadas</h3>
                                    <p>As atividades pontuadas calculam o desempenho do aluno com base no acerto da resposta e na agilidade, respeitando um tempo limite.</p>
                                    <p>A pontuação é inversamente proporcional ao tempo gasto: quanto mais demorada a resposta, menor a nota. Respostas incorretas não somam pontos.</p>
                                    <p>O sistema considera apenas o resultado da primeira tentativa. Mas caso o aluno não tenha acertado todas as questões, poderá refazer a atividade 
                                    para fins de aprendizado. Nessa nova etapa, não haverá cronômetro e a pontuação original não será alterada.</p>
                                    <hr>
                                    <p class="small">Uma atividade pontuada é uma atividade "refeita" com pontuação, logo para uma melhor experiência visual do sistema, restringimos os marcadores para que escolha uma atividade "refeita" ou "pontuada".</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                </div>
