        ...
        <div class="card-body">
            ...
            <div id="content_id" style="display:none">{{$content->id}}</div>
                ...
                <div class="form-group mt-4" style="width: 100%">
                    ...
                    <p style="text-align: center; font-size: 70%; margin: 0px 0px 5px; visibility: hidden" id="aguarde" >{{ __('Wait') }}...</p>
                    <div style="width: 50%; display: block;  margin-left: auto; margin-right: auto;">
                        ...
                        <br/>
                        <input type="button" value="{{ __('Close') }}" class="btn btn-success button_pre_compiler" style="width: 30%; display: block;  margin-left: auto; margin-right: auto;" id="fechar">
                    </div>
                    <div class="click_compilar" style="display:none">{{ __('Click') }}</div>

                    <div class="button_compiler" style="display:none">{{ __('Click') }}</div>
