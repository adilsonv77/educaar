        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('config.store') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="schoolName" type="text" class="form-control @error('name') is-invalid @enderror" name="schoolName"
                            value="{{ old('schoolName', $schoolName) }}" required autocomplete="schoolName" autofocus>
