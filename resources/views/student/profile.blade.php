...
<div class="container px-3 px-md-0">
    <div class="d-flex flex-column align-items-center mx-auto mt-4 rounded" style="width: 100%; max-width: 700px; background-color: #a156e4; border: 2px solid #7b01d8;" id="student-profile">

        
        <div class=" g-4 mx-auto my-auto px-4 bg-white py-4 d-flex flex-column align-items-center">
            <h1 class="mt-3 mb-1">Seu Perfil</h1>
            <div class="position-relative mx-auto mb-3 mt-3" style="width: 100px; height: 100px;">
        ...
        <div class="mt-2" style="height: 1px; width: 100%; background-color: #3e2c4e7e;"></div>

        <div class="g-4 mx-auto mb-2 mt-2 px-4 py-4" id="student-info">
