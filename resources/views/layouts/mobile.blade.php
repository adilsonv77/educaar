                            ...
                            <div class="aux">
                                <ul class="navbar-nav header-right">
                                    <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                        ...
                                        @if (session('type') == 'student')
                                            <a href="{{ route('student.profile') }}" title="{{ __('ui.action.profile') }}"
                                                class="ai-icon d-inline-block">
                                                <!--<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" style="margin-top: 8px;" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                                                    <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
                                                </svg>-->
                                                <img src="https://api.dicebear.com/9.x/toon-head/svg?seed=Luke&backgroundColor=b6e3f4" alt="Perfil" width="50px" height="50px" class="rounded-circle">
                                            </a>
                                        @endif
